...
function WorkStack() {
  ...
  return (
    <S.Navigator screenOptions={{ headerStyle: { backgroundColor: COLORS.blue }, headerTintColor: '#fff', headerTitleStyle: { fontWeight: '700' } }}>
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: { backgroundColor: '#fff', borderTopColor: COLORS.line, paddingBottom: 4 },
